...
//TODO make some kind of context object supporting OffscreenCanvas for WebWorker, headless-gl for node and basic WebGL1/2 for the browser

var isNode = !!(typeof process !== 'undefined' && process.versions && process.versions.node);
var isWeb = !!(typeof window === 'object' && typeof document === 'object');
var isWorker = !!(typeof WorkerGlobalScope !== 'undefined' && typeof self === 'object' && self instanceof WorkerGlobalScope);
var hasOffscreenCanvas = !!(typeof OffscreenCanvas === 'function');

console.log(isNode, isWeb, isWorker, hasOffscreenCanvas);
...
var GpuBackend = function GpuBackend (shape) {
    if (!isNode) {
        this.canvas = document.createElement('canvas'); //new OffscreenCanvas(1, 1);
    }
