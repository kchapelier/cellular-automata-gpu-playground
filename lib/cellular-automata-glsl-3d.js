...
var generateGetPosText = function generateGetPosText () {
    return [
        ...
        '  float sposition = position.x + position.y * iStride.y + position.z * iStride.z;',
        '  return vec2(',
...
var generateGetNeighbourhood = function (neighbourhood) {
    var glsl = [
        ...
        '    mod(floor(sposition / iStride.y), iRealSize.y),',
        '    floor(sposition / iStride.z)',
        '  );',
        '  int sum = 0;',
        ''
    ];
...
var generateUniformsAndConstants = function generateUniformsAndConstants (dimensions, textureWidth, textureHeight) {
    return [
        ...
        'const vec3 iStride = vec3(1, ' + dimensions[0] + ', ' + (dimensions[0] * dimensions[1]) + ');',
